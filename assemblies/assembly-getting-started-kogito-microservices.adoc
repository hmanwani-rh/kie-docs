...
include::{enterprise-dir}/getting-started-kogito/con-git-build-operator-deployment-option.adoc[leveloffset=+3]
include::{enterprise-dir}/getting-started-kogito/con-binary-build-operator-deployment-option.adoc[leveloffset=+3]
include::{enterprise-dir}/getting-started-kogito/con-custom-image-build-operator-deployment-option.adoc[leveloffset=+3]
