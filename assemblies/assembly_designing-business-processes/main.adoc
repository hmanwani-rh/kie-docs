...
include::{jbpm-dir}/BPMN2/create-business-rules-task-proc.adoc[leveloffset=+3]
include::{jbpm-dir}/BPMN2/create-script-task-proc.adoc[leveloffset=+3]
include::{jbpm-dir}/BPMN2/create-user-task-proc.adoc[leveloffset=+3]
include::{jbpm-dir}/BPMN2/create-service-task-proc.adoc[leveloffset=+3]

include::{jbpm-dir}/BPMN2/copy-process-proc.adoc[leveloffset=+2]
include::{jbpm-dir}/BPMN2/start-process-specific-node-proc.adoc[leveloffset=+2]
...
include::{enterprise-dir}/project-data/variables-con.adoc[leveloffset=+1]
...
* {URL_MANAGING_PROCESSES}[_{MANAGING_PROCESSES}_]
* {URL_INTERACTING_PROCESSES_TASKS}[_{INTERACTING_PROCESSES_TASKS}_]
