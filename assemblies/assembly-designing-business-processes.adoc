...
include::{enterprise-dir}/bpmn/proc-create-process-data-object.adoc[leveloffset=+3]
...
include::{enterprise-dir}/project-data/con-variable-tags.adoc[leveloffset=+2]
include::{enterprise-dir}/project-data/proc-define-global-variables.adoc[leveloffset=+2]
include::{enterprise-dir}/project-data/proc-define-process-variables.adoc[leveloffset=+2]
include::{enterprise-dir}/project-data/proc-define-local-variables.adoc[leveloffset=+2]
