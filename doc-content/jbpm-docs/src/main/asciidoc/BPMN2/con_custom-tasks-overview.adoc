...
For more information about enabling or disabling custom tasks in {CENTRAL}, see <<manage-service-tasks-proc_custom-tasks>>.
...
You can click *Assignments* in the *Properties* panel to open the *REST Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a rest custom task:
...
* *Content*: Data you want to send. This attribute is mandatory for `POST` and `PUT` requests.
...
* *ResultClass*: Valid name of the class consists of the transformed response if the given string format is not returned.
...
You can click *Assignments* in the *Properties* panel to open the *Email Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute an email custom task:
...
* *Debug*: Email server to intercept and store all passing email traffic.
...
A log custom task completes when the associated message is logged. You can click *Assignments* in the *Properties* panel to open the *Log Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a log custom task:
...
To invoke a web service from a process, you must use the correct task type. You can click *Assignments* in the *Properties* panel to open the *WS Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a web service custom task:
...
You can click *Assignments* in the *Properties* panel to open the *Milestone Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a milestone:
...
You can click *Assignments* in the *Properties* panel to open the *Decision Task Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a decision task:
...
You can use business rule tasks to evaluate key business rules in a business process. You can click *Assignments* in the *Properties* panel to open the *Business Rule Task Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a business rule task:
...
You can click *Assignments* in the *Properties* panel to open the *KafkaPublishMessages Data I/O* window and add data input and output as required. For example, enter the following data inputs in *Data Inputs and Assignments* fields which are required to execute a Kafka work item:
