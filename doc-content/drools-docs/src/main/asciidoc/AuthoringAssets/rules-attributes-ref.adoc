...
NOTE: When you use {PRODUCT} without the executable model, the consequences that are written using `dialect "JAVA"` support only Java 5 syntax. For more information about executable models, see
ifdef::DM,PAM[]
